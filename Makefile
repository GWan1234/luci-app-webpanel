...
define Package/luci-app-webpanel/install
	...
	$(INSTALL_DATA) ./luasrc/view/webpanel/iframe.htm $(1)/usr/lib/lua/luci/view/webpanel/
	$(INSTALL_DATA) ./luasrc/view/webpanel/overview.htm $(1)/usr/lib/lua/luci/view/webpanel/
